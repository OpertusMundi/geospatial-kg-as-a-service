...
from gkgaas.fagi.function import IsDateKnownFormat, IsValidDate, DatesAreSame, IsGeometryMoreComplex, \
    GeometriesCloserThan, GeometriesHaveSameArea, IsSameCentroid, IsPointGeometry, GeometriesIntersect, \
    IsGeometryCoveredBy, IsLiteralAbbreviation, IsSameNormalized, IsSameSimpleNormalize, IsSameCustomNormalize, \
    IsLiteralLonger, IsLiteralNumeric, IsNameValueOfficial, LiteralContains, LiteralContainsTheOther, \
    LiteralHasLanguageAnnotation, LiteralsHaveSameLanguageAnnotation, IsPhoneNumberParsable, IsSamePhoneNumber, \
    IsSamePhoneNumberCustomNormalize, IsSamePhoneNumberUsingExitCode, PhoneHasMoreDigits, Exists, NotExists
from gkgaas.fagi.function import IsDatePrimaryFormat
...
class TestFunctions(unittest.TestCase):
    def test_is_date_known_format(self):
        ...
        self.assertEqual(str(fn), expected_fn_str)
